...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    kitchenItemImage: json["kitchen_item_image"] == null ? [] : List<KitchenItemImage>.from(json["kitchen_item_image"]!.map((x) => KitchenItemImage.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "kitchen_item_image": kitchenItemImage == null ? [] : List<dynamic>.from(kitchenItemImage!.map((x) => x.toJson())),
...
class KitchenItemImage {
  ...
  factory KitchenItemImage.fromJson(Map<String, dynamic> json) => KitchenItemImage(
    images: json["images"],
  );
